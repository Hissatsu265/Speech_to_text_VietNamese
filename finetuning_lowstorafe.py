...
#     eval_strategy="steps",
#     eval_steps=500,
#     save_strategy="no",  # ✅ KHÔNG LƯU CHECKPOINT TRONG QUÁ TRÌNH TRAINING
#     logging_steps=50,
    
#     # Best model - TẮT vì không có checkpoint
#     load_best_model_at_end=False,  # ✅ Tắt vì không lưu checkpoint
...
#     # Misc
#     push_to_hub=False,
#     resume_from_checkpoint=False,  # ✅ Tắt resume vì không có checkpoint
...
LANGUAGE = "Vietnamese"
TASK = "transcribe"
OUTPUT_DIR = "./whisper-vietnamese-finetuned-fixed"
MAX_AUDIO_DURATION = 30.0
...
if hasattr(model.config, 'attention_dropout'):
    model.config.attention_dropout = 0.0
# ✅ CẤU HÌNH GENERATION ĐỂ TRÁNH LẶP TỪ (THÊM VÀO ĐÂY)
...
training_args = Seq2SeqTrainingArguments(
    ...
    # Generation (✅ SỬA ĐỂ TRÁNH LẶP TỪ)
    predict_with_generate=True,
    generation_max_length=128,  # Giảm từ 225 → 128
    generation_num_beams=5,     # Beam search
    # generation_config={
